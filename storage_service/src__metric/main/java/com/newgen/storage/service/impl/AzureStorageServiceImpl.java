...
public class AzureStorageServiceImpl extends ExceptionThrower implements ThirdPartyStorageService {
	...
	public String upload(String contentPath, StorageCredentials storageCredentials, String containerName,
		...
		String storageConnectionString = DEFAULT_ENDPOINTS_PROTOCOL + storageCredentials.getStorageProtocol()
				+ ACCOUNT_NAME + storageCredentials.getAccountName() + ACCOUNT_KEY + storageCredentials.getAccountKey();
		...
		boolean containerexist = container.createIfNotExists();
		if (containerexist == true) {
			callLoggingService(container.getName(), null, "Blob", null, null, null, null, "CREATE", "StorageService");
		}
...
//		logger.debug("Upload file name: " + uploadFileName);
		...
		blobMetadata.put("id", documentId);
	...
	public String delete(StorageLocation storageLocation, StorageCredentials storageCredentials)
			throws CustomException, URISyntaxException, StorageException, InvalidKeyException {
	...
	public String download(StorageLocation storageLocation, StorageCredentials storageCredentials)
			throws CustomException, URISyntaxException, StorageException, InvalidKeyException {
		 ...
		 * containerPermissions.setPublicAccess(BlobContainerPublicAccessType.OFF); Name
		 * the shared access policy: heath
		 */
