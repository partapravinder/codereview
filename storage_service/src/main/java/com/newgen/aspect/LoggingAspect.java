...
public class LoggingAspect {
	...
	private static final Logger logger = LoggerFactory.getLogger(LoggingAspect.class);
	 ...
	 @Around("execution(* com.newgen.controller.StorageController.*(..)) || execution(* com.newgen.controller.CronJobController.*(..)) || execution(* com.newgen.service.StorageCredentialService.*(..)) || execution(* com.newgen.service.StorageLocationService.*(..))|| execution(* com.newgen.service.StorageProcessService.*(..))")
...
//		logger.debug("Method : " + MethodSignature.class.cast(joinPoint.getSignature()).getMethod().getName()
