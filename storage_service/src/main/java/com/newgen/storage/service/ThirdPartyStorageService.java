...
public interface ThirdPartyStorageService {
	...
	public String upload(String contentPath, StorageCredentials storageCredentials, String containerName, String documentId) throws CustomException, Exception;//NOSONAR
