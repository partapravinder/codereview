...
public class LoggingAspect {
	...
	@Around("execution(* com.newgen.controller.DataClassController.*(..)) || execution(* com.newgen.service.DataClassService.*(..)) || execution(* com.newgen.dao.impl.DataClassDaoImpl.*(..))")
