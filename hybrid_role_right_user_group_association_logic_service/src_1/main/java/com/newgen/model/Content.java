...
public class Content {
	...
	public Content(String id, String name, String contentType, String comments, String parentFolderId, String ownerName,
			String ownerId, String contentLocationId, Date creationDateTime, Date revisedDateTime,
			Date accessDateTime, String noOfPages, String documentType, String documentSize, Map<String, String> metadata,String tenantId) {
		super();
		this.id = id;
		this.name = name;
