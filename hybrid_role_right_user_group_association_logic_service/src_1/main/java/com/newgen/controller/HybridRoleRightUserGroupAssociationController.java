...
public class HybridRoleRightUserGroupAssociationController {
	...
	public ResponseEntity<String> getUserContentRightsById(@RequestHeader(value = "tenantId") String tenantId, @PathVariable("objectId") String objectId,
			@PathVariable("userId") String userId, HttpServletRequest request) throws JSONException, JsonProcessingException, CustomException {
	...
	@ApiResponses(value = {
			...
			@ApiResponse(code = 503, message = "Database connection failure"),
			@ApiResponse(code = 400, message = "Exception Message") })
	public ResponseEntity<String> getUserFolderRightsById(@RequestHeader(value = "tenantId") String tenantId, @PathVariable("objectId") String objectId,
			@PathVariable("userId") String userId, HttpServletRequest request) throws JSONException, JsonProcessingException, CustomException {
		logger.debug("Entering getUserGroupAssociationById()");
		//String authToken = request.getHeader("authToken").toString();
