 ...
 * 
 * @JsonInclude(value = Include.NON_EMPTY) public class Lock {
 * 
 ...
 * 
 * @DateTimeFormat(iso = ISO.DATE_TIME) private Date _ts;
 * 
 ...
 * public Lock(){ super(); }
 * 
 * public Lock(String id, String appId, Date ts,String tenantId) { super();
 * this.id = id; this.appId = appId; this._ts = ts; this.tenantId = tenantId; }
 * 
 * 
 * 
 * public Lock(String id, String appId, Date ts, String lockType, int
 * sharedCount,String tenantId) { super(); this.id = id; this.appId = appId;
 * this._ts = ts; this.lockType = lockType; this.sharedCount = sharedCount;
 ...
 * 
 * @Override public String toString() { return "Lock [id=" + id + ", appId=" +
 * appId + ", ts=" + _ts + ", lockType=" + lockType + ", sharedCount=" +
 ...
 *//**
	 ...
	 */
/*
 * public Date getTs() { return _ts; }
 * 
 *//**
	 * @param ts the ts to set
	 */
/*
 * public void setTs(Date ts) { this._ts = ts; }
 * 
 *//**
	 * @return the lockType
	 */
