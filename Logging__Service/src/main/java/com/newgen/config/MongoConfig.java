 ...
 * 
 * import com.mongodb.MongoClient; import com.mongodb.MongoClientURI; //import
 * com.newgen.converter.ContentReaderConverter; //import
 * com.newgen.converter.ContentWriterConverter; //import
 * com.newgen.converter.FolderReaderConverter; //import
 * com.newgen.converter.FolderWriterConverter;
 * 
 ...
 * 
 * @Value("${spring.data.mongodb.uri}") private String mongoClientUri;
 * 
 ...
 * FolderWriterConverter()); converters.add(new FolderReaderConverter());
 * converters.add(new ContentWriterConverter()); converters.add(new
 * ContentReaderConverter()); return new CustomConversions(converters); }
 * 
 * @Override public MongoCustomConversions customConversions() { //
 * converters.add(new FolderWriterConverter()); // converters.add(new
 * FolderReaderConverter()); // converters.add(new ContentWriterConverter()); //
 * converters.add(new ContentReaderConverter()); return new
