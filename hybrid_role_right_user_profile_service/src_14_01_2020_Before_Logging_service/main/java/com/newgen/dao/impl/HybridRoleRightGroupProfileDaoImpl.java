...
public class HybridRoleRightGroupProfileDaoImpl implements HybridRoleRightGroupProfileDao {
	...
	public GroupProfile findAndModifyByGroup(String updateParams, String tenantId)
		...
		if (updateParams != null) {
			...
			if (updatedParamsJson.has("profiles") && updatedParamsJson.get("profiles") != null) {
				...
				// Get existing
				GroupProfile profile_temp = findById(groupId, tenantId);
	...
	@Override
	public GroupProfile findAndDeallocateProfileFromGroupId(String tenantId, String groupId, String[] objectIds)
			throws CustomException {
		Map<String, Object> updateParams = new HashMap<String, Object>();
		// updateParams.put("userIds", userId);
