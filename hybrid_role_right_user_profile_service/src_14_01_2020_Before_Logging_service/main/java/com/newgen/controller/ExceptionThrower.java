...
public class ExceptionThrower {
	...
	public void throwUserIdNotPresentInThisGroup() throws CustomException {
		throw new CustomException(HttpStatus.BAD_REQUEST.value(), "User Id(s) not associated with this group for this tenant.",
				HttpStatus.BAD_REQUEST);
	}
	public void throwNoUserIdNotPresentInThisGroup() throws CustomException {
		throw new CustomException(HttpStatus.BAD_REQUEST.value(), "No User Id is associated with this group for this tenant.",
				HttpStatus.BAD_REQUEST);
	}
	public void throwNoUserIdNotPresentInRequest() throws CustomException {
		throw new CustomException(HttpStatus.BAD_REQUEST.value(), "No User Id is present.",
				HttpStatus.BAD_REQUEST);
	}
