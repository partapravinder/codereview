...
//    private String folderServiceId;
	...
	public ResponseEntity<String> deleteChildFolders(String folderId,String version, String tenantId) throws JSONException {
		...
		// Query parameters
		UriComponentsBuilder builder = UriComponentsBuilder.fromUriString(folderServiceUrl + folderApiPath + "/" + folderId);
		// Add query parameter
		if (version != null) {
		...
		HttpEntity<FolderDTO> request = new HttpEntity<>(headers);
