...
public class LoggingAspect {
	...
	@Around("execution(* com.newgen.controller.CabinetController.*(..)) || execution(* com.newgen.service.FolderService.*(..)) || execution(* com.newgen.doa.impl.FolderDaoImpl.*(..)) || execution(* com.newgen.doa.impl.LockDaoImpl.*(..))")
...
//		System.out.println("Method : " + MethodSignature.class.cast(joinPoint.getSignature()).getMethod().getName()
