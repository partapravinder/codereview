...
public class Folder {
	...
	public Folder(String id, String folderName, String folderType, String comments, String parentFolderId,
			String ownerName, String ownerId, Date creationDateTime, String usedFor, String metadataId, Map<String, String> metadata,String tenantId) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Folder [id=" + id + ", folderName=" + folderName + ", folderType=" + folderType + ", comments="
				...
				+ ", accessDateTime=" + accessDateTime + ", usedFor=" + usedFor + ", version=" + version + ", metadataId=" + metadataId + ", tenantId=" + tenantId +"]";
	}
